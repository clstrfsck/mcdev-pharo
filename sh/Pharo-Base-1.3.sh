#!/bin/bash
# Bootstrap Pharo 1.3 Linux VM and image from upstream
set -e

# Some useful vars for later
SCRIPTDIR="`dirname $0`"
PKGNAME="`basename $0 .sh`"
IMGNAME=Pharo-1.3.image
...
# Retrieve Pharo 1.3 image into local zip file from Jenkins
